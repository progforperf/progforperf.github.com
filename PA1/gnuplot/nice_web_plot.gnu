...
set terminal postscript enhanced eps color font 'Verdana,16' 
# wxt
...
# color definitions
set style line 1 lc rgb '#8b1a0e' pt 1 ps 1 lt 1 lw 4 # --- red
set style line 2 lc rgb '#5e9c36' pt 6 ps 1 lt 1 lw 4 # --- green
...
#replot
!epstopdf --outfile=nice_web_plot.pdf nice_web_plot.eps
